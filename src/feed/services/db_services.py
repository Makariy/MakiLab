...
def get_feed_post_by_params(**params):
    """Returns feed post <feed.models.FeedPost> that suites the params.
...
def get_feed_post_image_by_params(**params):
    """Returns feed post image <feed.models.FeedPostImage> that suites the params.
...
def get_feed_post_comment_by_params(**params):
    """Returns feed post comment <feed.models.FeedPostComment> that suites the params.
...
def get_feed_post_like_by_params(**params):
    """Returns feed post like <feed.models.FeedPostLike> that suites the params.
...
def get_feed_post_likes_count(feed_post_id: int):
    """Returns post <feed.models.FeedPost> likes count"""
...
def get_feed_post_like_by_post_and_author(feed_post: FeedPost, like_author: User):
    """Returns post <feed.models.FeedPost> like which author is <like_author>,
...
def get_last_feed_posts(author_id: User, start_post_id: FeedPost = None, count=10):
    """Returns last <count> posts <feed.models.FeedPost> whose author_id is <author_id>
...
def get_user_by_params(**params):
    """Returns user <django.contrib.auth.models.User> that suites the params,
