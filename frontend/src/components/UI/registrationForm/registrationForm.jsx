...
const RegistrationForm = () => {
    ...
    const onSubmitClicked = (e) => {
        ...
        registerOnServer(usernameRef.current.value, passwordRef.current.value)
            .then(response => {
                            ...
                            <div className={classes.login__inner}>
                                ...
                                <form className={classes.login__form}>
                                    ...
                                    <div className={classes.login__form_submit}>
                                        <input value="Singup" type="submit" onClick={onSubmitClicked} className={classes.login__form_submit_button}/>
                                    </div>
